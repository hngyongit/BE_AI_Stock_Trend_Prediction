...
class StockDataService:
    ...
    def normalize_analysis_data(self, payload: Any) -> dict[str, Any]:
        ...
        return {
            ...
            "financials_merged": self._first_dict(data, "financials_merged", "financialsMerged"),
            "financial_source_contributions": self._first_list(data, "financial_source_contributions", "financialSourceContributions"),
            "financial_conflicts": self._first_list(data, "financial_conflicts", "financialConflicts"),
            "financial_cross_checks": self._first_list(data, "financial_cross_checks", "financialCrossChecks"),
            "cafef_financial_contribution": self._first_dict(data, "cafef_financial_contribution", "cafefFinancialContribution"),
            "financial_backfill_report": self._first_dict(data, "financial_backfill_report", "financialBackfillReport"),
            "_financial_merge_report": self._first_dict(data, "_financial_merge_report", "financial_merge_report", "financialMergeReport"),
